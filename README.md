...
3. How do we use state in a class component?
4. Which do you prefer more, classes or function components?
...
* Implements the component using Function Components
* Implement this component using Class Components
